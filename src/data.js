...
export const profile = {
    ...
    contact: {
        ...
        github: "https://github.com/AndreSaul16/" // Assuming github based on icons, URL not explicit in text but standard
    },
    socials: [
        { name: "LinkedIn", url: "https://www.linkedin.com/in/sbriceño/", icon: Linkedin },
        { name: "Email", url: "mailto:andresaul16s@gmail.com", icon: Mail },
        { name: "Github", url: "https://github.com/AndreSaul16/", icon: Github },
    ]
};
